...
//popUp
    ...
    const validator = () =>{
        const phone = document.querySelectorAll('input[type="tel"]'),
               nameText = document.querySelectorAll('input[type="text"]'),
                textForm = document.getElementById('form2-message');
        ...
        phone.forEach((elem) =>{
            elem.addEventListener('input', showLog);
        });
        nameText.forEach((elem) =>{
            elem.addEventListener('input', showText);
        });
        textForm.addEventListener('input', showText);
